...
public class Main {
	...
	public static void main(String[] args) {
		...
		// System.out.printf("Area é de %2f",area);
		...
		int y;
		double z;
		x = sc.next(); // Solicita a inserção do dado String ao usuário
		System.out.println("Você digitou: " + x);

		y = sc.nextInt();// Solicita a inserção do dado Integer ao usuário
		System.out.println("Você digitou: " + y);

		z = sc.nextDouble();// Solicita a inserção do dado Double ao usuário
